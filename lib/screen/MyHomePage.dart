  ...
  Widget buildAppBar(BuildContext context) {
    return Directionality(
      ...
      child: SliverAppBar(
        ...
        actions: [
          IconButton(onPressed: (){}, icon:Icon(Icons.notification_important_rounded,color: Colors.black,)),
                        ...
                        child: Container(
                            ...
                            child: RichText(
                             ...
                             //   style: DefaultTextStyle.of(context).style,
                                children: <TextSpan>[
                                  TextSpan(text: 'السوق', style: TextStyle(fontWeight: FontWeight.bold,color: Colors.green,fontSize: 20)),
                                  TextSpan(text: ' المفتوح!',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue,fontSize: 18)),
                                ],
                              ),
                            )
                        ),
                    ...
                    Expanded(
                      ...
                      child: Container(
                        ...
                        child: TabBar(
                          ...
                          tabs: [
                            Tab(
                              child: Text( 'الاعلانات',style: TextStyle(
                                fontSize: 18,
                                color: _productController.selectedTabIndex== 0
                                    ? Cons.accent_color
                                    : Colors.black
                              ),),
                            ...
                            Tab(
                              child: Text('الاقسام',style: TextStyle(
                                  fontSize: 18,
                                  color: _productController.selectedTabIndex== 1
                                      ? Cons.accent_color
                                      : Colors.black
                              )),
                            ...
                            Tab(
                              child: Text('متاجر',style: TextStyle(
                                  fontSize: 18,
                                  color: _productController.selectedTabIndex== 2
                                      ? Cons.accent_color
                                      : Colors.black
                              )),
                            ...
                            Tab(
                              child: Text('شوهد',style: TextStyle(
                                  fontSize: 18,
                                  color: _productController.selectedTabIndex== 3
                                      ? Cons.accent_color
                                      : Colors.black
                              )),
              ...
              children: [
                ...
                Container(
                  ...
                  child: Center(child: Text(
                    'المزيد', style: TextStyle(color: Colors.white),),),
                ),
              ],
            ),
            SizedBox(height: 15,),
          ...
          children: [
            ...
            Container(
              ...
              child: RaisedButton(
                ...
                onPressed: () {},
                child: Text(
                  ' +  أضف متجرك الان', style: TextStyle(color: Colors.white,fontSize: 15),),),
            ),
